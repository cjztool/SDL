...
../configure --target=armv7-android-gcc --sdk-path=../../../../../../android-ndk-r13b --extra-cflags="-mfloat-abi=softfp -mfpu=neon" --disable-runtime-cpu-detect --disable-pic --disable-realtime-only
