...
SDL_DYNAPI_PROC(void,SDL_SetAppEventHandler, (SDL_AppEventHandler a, void *b), (a, b), )
SDL_DYNAPI_PROC(void,SDL_SetBackgroundHandler, (SDL_BackgroundHandler a, void *b), (a, b), )
